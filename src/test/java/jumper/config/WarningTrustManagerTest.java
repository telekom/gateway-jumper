...
class WarningTrustManagerTest {
  ...
  void testCheckServerTrusted_ValidCertificate_NoException() throws CertificateException {
    // Given: delegate trust manager validates successfully
    doNothing().when(delegateTrustManager).checkServerTrusted(any(), anyString());

    // When: checking server certificate
    // Then: should not throw exception
    assertDoesNotThrow(
        () -> warningTrustManager.checkServerTrusted(certificateChain, "RSA"));
  ...
  @Test
  void testCheckServerTrusted_InvalidCertificate_NoExceptionThrown()
      throws CertificateException {
    // Given: delegate trust manager throws exception (invalid certificate)
  ...
  void testCheckClientTrusted_ValidCertificate_NoException() throws CertificateException {
    ...
    // Then: should not throw exception
    assertDoesNotThrow(
        () -> warningTrustManager.checkClientTrusted(certificateChain, "RSA"));
  ...
  @Test
  void testCheckClientTrusted_InvalidCertificate_NoExceptionThrown()
      throws CertificateException {
    // Given: delegate trust manager throws exception
