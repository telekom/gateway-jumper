...
public class WarningTrustManager extends X509ExtendedTrustManager {
  ...
  private static final String METRIC_CERT_VALIDATION_FAILURE =
      "jumper.ssl.certificate.validation.failure";
  private static final String METRIC_CERT_VALIDATION_SUCCESS =
  ...
  private void recordValidationFailure(
    ...
    tags.add(Tag.of("result", "failure"));

    Counter.builder(METRIC_CERT_VALIDATION_FAILURE)
  ...
  private void recordValidationSuccess(
      String hostname, String issuer, String certificateType) {
    List<Tag> tags = new ArrayList<>();
    tags.add(Tag.of("hostname", hostname));
    tags.add(Tag.of("issuer", issuer));
    tags.add(Tag.of("certificate_type", certificateType));
    tags.add(Tag.of("result", "success"));

    Counter.builder(METRIC_CERT_VALIDATION_SUCCESS)
