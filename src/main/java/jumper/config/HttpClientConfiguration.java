...
public class HttpClientConfiguration {
  ...
  private SslContext createSslContextWithCustomizedCiphers() throws SSLException {
    ...
    if (StringUtils.isNotBlank(tlsHardeningConfiguration.getAllowedNamedGroups())) {
      System.setProperty("jdk.tls.namedGroups", tlsHardeningConfiguration.getAllowedNamedGroups());
    }
